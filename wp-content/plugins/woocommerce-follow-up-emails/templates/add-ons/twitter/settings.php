...
<div id="twitter-guide" style="display: none;">
	<blockquote>
		<p>
			<?php _e('To get your API Keys, create a <a href="https://developer.twitter.com/en/apps">new Twitter App</a> and set the following values:', 'follow_up_emails'); ?>
		</p>
		<ul>
			...
			<li><strong>Callback URL:</strong> <?php printf( __('Set to <code>%s</code>', 'follow_up_emails'), WC()->api_request_url( 'wc_fue_twitter' ) ); ?></li>

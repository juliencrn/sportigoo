...
$rocket_cookie_hash = 'abeeee862d75d27559299e58e2d704ec';
$rocket_logged_in_cookie = 'wordpress_logged_in_abeeee862d75d27559299e58e2d704ec';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?|/(?:.+/)?embed/|/commande/(.*)|/panier/|/mon-compte/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5d404597ac051325135482';
$rocket_cache_ssl = 1;

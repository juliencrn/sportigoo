...
<div class="wrap">
	...
	<?php if (isset($_GET['renamed'])): ?>
		<div id="message" class="updated"><p><?php printf(_n('1 subscriber has been renamed', '%d subscribers have been renamed', intval($_GET['renamed']), 'follow_up_emails'), intval($_GET['renamed'])); ?></p></div>
	<?php endif; ?>

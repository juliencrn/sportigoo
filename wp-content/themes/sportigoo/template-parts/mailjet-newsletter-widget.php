...
<div id="the_news" class="mailjet_widget_front_container">
    <?php
    extract( $args );
    ...
    <div class="widget-text wp_widget_plugin_box">
        ...
        <!--Widget form-->
        <form method="post" action=" <?php echo esc_url( $_SERVER['REQUEST_URI'] ) ?>#mjForm" id="mjForm"
              name="mjForm">
            ...
            <div class="newsletter">
                ...
                <!--            <div class="">-->
                <input type="email" name="subscription_email" id="mailjet_widget_email" required="required"
                       placeholder="<?php echo $emailLabel ?>">
                <input type="hidden" name="subscription_locale" id="mailjet_widget_locale"
                    ...
                    if ( 'bool' === $inputType ) {
                        ...
                        <div class="form-group" style="margin-bottom: 10px!important">
                            <input type="checkbox" <?php echo $required ?>
                                   name="properties[<?php echo $contactPropertyId ?>]"
                                   id="mailjet_property_<?php echo $i ?>" <?php echo $value ?> />
                        ...
                        ?>
                        <div class="form-group" style="margin-bottom: 10px!important">
                            <input <?php echo $required ?> type="text" class="mj_form_property <?php echo $class ?>"
                                                           name="properties[<?php echo $contactPropertyId ?>]" <?php echo $value ?>
                                                           placeholder="<?php
                                                           echo $requiredStar;
                                                           echo $placeholder
                ...
                ?>
                <input type="submit" class="button button--white" value="<?php echo $buttonLabel ?>">
            </div><!-- .newsletter -->
        </form>

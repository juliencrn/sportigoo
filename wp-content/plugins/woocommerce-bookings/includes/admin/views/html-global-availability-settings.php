...
<form method="post" action="" id="bookings_settings">
	...
	<div id="poststuff">
		<div class="postbox">
			<h3 class="hndle"><?php esc_html_e( 'Global availability', 'woocommerce-bookings' ); ?></h3>
			<div class="inside">
				<p class=""><?php esc_html_e( 'The availability rules you define here will affect all bookable products in your store.', 'woocommerce-bookings' ); ?></p>

...
add_action( 'wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script( 'mapsvg-js', $root . 'static/map/mapsvg.min.js', null, null, true );
    ...
    // Dependencies
    $deps = array('jquery', 'gsap-js', 'slick-js', 'mapsvg-js', 'cookiec-onsent2-js', 'jquery-modal-js');

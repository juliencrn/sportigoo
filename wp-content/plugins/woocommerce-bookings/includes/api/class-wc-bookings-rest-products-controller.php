		...
		return array(
			...
			'availability'               => array(
				...
				'items'       => array(
					...
					'properties' => array(
						'type'      => array(
							'description' => __( 'Availability type.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'from'      => array(
							'description' => __( 'Starting month/day/week inclusive.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'to'        => array(
							'description' => __( 'Ending month/day/week inclusive.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'from_date' => array(
							'description' => __( 'Starting day if \'from\' is a time.,', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'to_date'   => array(
							'description' => __( 'Ending day if \'to\' is a time.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'bookable'  => array(
							'description' => __( 'Rule marks things as bookable or not, \'yes\' or \'no\'.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'priority'  => array(
							'description' => __( 'Priority of rule.', 'woocommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view', 'edit' ),
						),
					),
			...
			'pricing'                    => array(
				...
				'items'       => array(
					...
					'properties' => array(
						'type'               => array(
							'description' => __( 'Date range type.', 'woocommerce' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'from'               => array(
						...
						'modifier'      => array(
							'description' => __( 'How the block cost should be modified.', 'woocommerce' ),
							'type'      => 'string',
							'enum'        => array( '+', 'minus', 'times', 'divide', 'equals' ),
							'context'     => array( 'view', 'edit' ),
						),
						'cost'               => array(
							'description' => __( 'Block cost.', 'woocommerce' ),
							'type'      => 'number',
							'context'     => array( 'view', 'edit' ),
						),
						'base_modifier' => array(
							'description' => __( 'How the base cost should be modified.', 'woocommerce' ),
							'type'      => 'string',
							'enum'        => array( '+', 'minus', 'times', 'divide', 'equals' ),
							'context'     => array( 'view', 'edit' ),
						),
						'base_cost'          => array(
							'description' => __( 'Base cost.', 'woocommerce' ),
							'type'      => 'number',
							'context'     => array( 'view', 'edit' ),
						),
						'priority'           => array(

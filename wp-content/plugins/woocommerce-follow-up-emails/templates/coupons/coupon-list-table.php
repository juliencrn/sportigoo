				...
				<table class="widefat fixed striped posts">
					...
					<tr>
						...
						<th scope="col" id="email_address" class="manage-column column-usage_count <?php echo $email_address_class .' '. $email_address_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-coupons&tab=reports&sortby=email_address&sort=<?php echo $email_address_dir; ?>&v=coupons#usage">
						...
						<th scope="col" id="used" class="manage-column column-used <?php echo $used_class .' '. $used_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-coupons&tab=reports&sortby=coupon_used&sort=<?php echo $used_dir; ?>&v=coupons#usage">
						...
						<th scope="col" id="date_sent" class="manage-column column-date_sent <?php echo $sent_class .' '. $sent_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-coupons&tab=reports&sortby=date_sent&sort=<?php echo $sent_dir; ?>&v=coupons#usage">
